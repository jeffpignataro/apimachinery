...
var map_List = map[string]string{
	...
	"metadata": "Standard list metadata. More info: https://git.github.com/jeffpignataro/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds",
...
var map_ListMeta = map[string]string{
	...
	"resourceVersion":    "String that identifies the server's internal version of this object that can be used by clients to determine when objects have changed. Value must be treated as opaque by clients and passed unmodified back to the server. Populated by the system. Read-only. More info: https://git.github.com/jeffpignataro/community/contributors/devel/sig-architecture/api-conventions.md#concurrency-control-and-consistency",
...
var map_ObjectMeta = map[string]string{
	...
	"generateName":               "GenerateName is an optional prefix, used by the server, to generate a unique name ONLY IF the Name field has not been provided. If this field is used, the name returned to the client will be different than the name passed. This value will also be combined with a unique suffix. The provided value has the same validation rules as the Name field, and may be truncated by the length of the suffix required to make the value unique on the server.\n\nIf this field is specified and the generated name exists, the server will return a 409.\n\nApplied only if Name is not specified. More info: https://git.github.com/jeffpignataro/community/contributors/devel/sig-architecture/api-conventions.md#idempotency",
	...
	"resourceVersion":            "An opaque value that represents the internal version of this object that can be used by clients to determine when objects have changed. May be used for optimistic concurrency, change detection, and the watch operation on a resource or set of resources. Clients must treat these values as opaque and passed unmodified back to the server. They may only be valid for a particular resource or set of resources.\n\nPopulated by the system. Read-only. Value must be treated as opaque by clients and . More info: https://git.github.com/jeffpignataro/community/contributors/devel/sig-architecture/api-conventions.md#concurrency-control-and-consistency",
	"generation":                 "A sequence number representing a specific generation of the desired state. Populated by the system. Read-only.",
	"creationTimestamp":          "CreationTimestamp is a timestamp representing the server time when this object was created. It is not guaranteed to be set in happens-before order across separate operations. Clients may not set this value. It is represented in RFC3339 form and is in UTC.\n\nPopulated by the system. Read-only. Null for lists. More info: https://git.github.com/jeffpignataro/community/contributors/devel/sig-architecture/api-conventions.md#metadata",
	"deletionTimestamp":          "DeletionTimestamp is RFC 3339 date and time at which this resource will be deleted. This field is set by the server when a graceful deletion is requested by the user, and is not directly settable by a client. The resource is expected to be deleted (no longer visible from resource lists, and not reachable by name) after the time in this field, once the finalizers list is empty. As long as the finalizers list contains items, deletion is blocked. Once the deletionTimestamp is set, this value may not be unset or be set further into the future, although it may be shortened or the resource may be deleted prior to this time. For example, a user may request that a pod is deleted in 30 seconds. The Kubelet will react by sending a graceful termination signal to the containers in the pod. After that 30 seconds, the Kubelet will send a hard termination signal (SIGKILL) to the container and after cleanup, remove the pod from the API. In the presence of network partitions, this object may still exist after this timestamp, until an administrator or automated process can determine the resource is fully terminated. If not set, graceful deletion of the object has not been requested.\n\nPopulated by the system when a graceful deletion is requested. Read-only. More info: https://git.github.com/jeffpignataro/community/contributors/devel/sig-architecture/api-conventions.md#metadata",
...
var map_OwnerReference = map[string]string{
	...
	"kind":               "Kind of the referent. More info: https://git.github.com/jeffpignataro/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds",
...
var map_PartialObjectMetadata = map[string]string{
	...
	"metadata": "Standard object's metadata. More info: https://git.github.com/jeffpignataro/community/contributors/devel/sig-architecture/api-conventions.md#metadata",
}
...
var map_Status = map[string]string{
	...
	"metadata": "Standard list metadata. More info: https://git.github.com/jeffpignataro/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds",
	"status":   "Status of the operation. One of: \"Success\" or \"Failure\". More info: https://git.github.com/jeffpignataro/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status",
...
var map_StatusDetails = map[string]string{
	...
	"kind":              "The kind attribute of the resource associated with the status StatusReason. On some operations may differ from the requested resource Kind. More info: https://git.github.com/jeffpignataro/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds",
...
var map_TypeMeta = map[string]string{
	...
	"kind":       "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.github.com/jeffpignataro/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds",
	"apiVersion": "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.github.com/jeffpignataro/community/contributors/devel/sig-architecture/api-conventions.md#resources",
}
